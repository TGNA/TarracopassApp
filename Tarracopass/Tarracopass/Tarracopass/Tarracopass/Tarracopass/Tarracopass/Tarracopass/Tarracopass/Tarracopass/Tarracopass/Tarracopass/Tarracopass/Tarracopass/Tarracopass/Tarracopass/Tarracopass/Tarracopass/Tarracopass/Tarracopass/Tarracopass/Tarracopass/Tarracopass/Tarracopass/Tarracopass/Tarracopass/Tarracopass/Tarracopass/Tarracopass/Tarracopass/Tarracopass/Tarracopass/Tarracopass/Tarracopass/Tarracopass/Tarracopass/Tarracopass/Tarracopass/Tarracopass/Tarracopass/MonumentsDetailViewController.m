//
//  MonumentsDetailViewController.m
//  Tarracopass
//
...
#import "MonumentsMapViewController.h"
#import "MonumentsTimeTableViewController.h"
...
@interface MonumentsDetailViewController () <FTCoreTextViewDelegate>

@end

@implementation MonumentsDetailViewController

@synthesize monumentsName;

- (void)viewDidLoad
{
    [super viewDidLoad];
    // Do any additional setup after loading the view, typically from a nib.
    NSDictionary *item = monumentsName;
...
- (IBAction)map:(id)sender {
    ...
    [self performSegueWithIdentifier: @"MonumentsMapShow" sender: self];

}

-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    if([[segue identifier] isEqualToString:@"MonumentsMapShow"])
    {
        MonumentsMapViewController *destViewController = [segue destinationViewController];
        destViewController.monumentsLocation = monumentsName;
    }
}
...
- (IBAction)timetables:(id)sender {
    ...
    formSheet.willPresentCompletionHandler = ^(UIViewController *presentedFSViewController) {
        // Passing data
        MonumentsTimeTableViewController *destViewController = (MonumentsTimeTableViewController *)presentedFSViewController;
        destViewController.monumentsTime = monumentsName;
...
- (NSArray *)coreTextStyle
{
    ...
    defaultStyle.font = [UIFont fontWithName:@"OpenSans-Regular" size:16.f];
    defaultStyle.textAlignment = FTCoreTextAlignementJustified;
    [result addObject:defaultStyle];
    
    //  Create style using convenience method
    FTCoreTextStyle *titleStyle = [FTCoreTextStyle styleWithName:@"title"];
    titleStyle.font = [UIFont fontWithName:@"OpenSans-Regular" size:40.f];
    ...
    bulletStyle.bulletFont = [UIFont fontWithName:@"OpenSans-Regular" size:16.f];
