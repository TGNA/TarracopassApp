...
@interface MonumentsMapViewController ()

@end

@implementation MonumentsMapViewController

@synthesize monumentsLocation;
...
- (void)viewDidLoad {
    ...
    NSDictionary *item = monumentsLocation;
