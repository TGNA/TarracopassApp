//
//  MonumentsTimeTableViewController.m
//  Tarracopass
//
...
@interface MonumentsTimeTableViewController () <FTCoreTextViewDelegate>
@end

@implementation MonumentsTimeTableViewController

@synthesize monumentsTime;
- (void)viewDidLoad {
    [super viewDidLoad];
...
{
    NSDictionary *item = monumentsTime;
